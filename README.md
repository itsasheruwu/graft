...
| **AI Rewriter** | Optional local Codex helper for turning a plain-English page rewrite prompt into previewed, safe Element Selector recipes. Recipes persist per domain after approval. |
